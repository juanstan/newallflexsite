                ...
                <div class="col-md-12 col-centered" >
                    <div role="tabpanel small-top-buffer">
                        <ul class="nav mobile-nav nav-pills">
                            <li class="active "><a href="#vetLocation" aria-controls="vetLocation" role="tab" data-toggle="tab">{!! Lang::get('general.Location') !!}</a></li>
                            <li class="report-toggle"><a href="#vetName" aria-controls="vetName" role="tab" data-toggle="tab">{!! Lang::get('general.Vet Practice') !!}</a></li>
                        </ul>
    ...
    <div class="row large-top-buffer" >
        <div class="col-md-12 col-centered" >
            <div class="form-group">
                <div class="col-sm-12">
                     <a href="{!! URL::route('user.register.vet') !!}" >
                    ...
                    <a href="{!! URL::route('user.register.reading') !!}" >
                        {!! Form::button(Lang::get('general.Next'), array('class' => 'btn btn-default btn-lg pull-right border-none')) !!}
                    </a>
                </div>
            </div>
        </div>
