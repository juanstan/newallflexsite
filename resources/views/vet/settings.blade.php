                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="radio-pill-buttons">
                            <label><input type="radio" @if(Auth::vet()->get()->units == 0) checked @endif name="units" value="0"><span class="pointer" >{!! Lang::get('general.Celcius') !!}</span></label>
                            <label><input type="radio" @if(Auth::vet()->get()->units == 1) checked @endif name="units" value="1"><span class="pointer" >{!! Lang::get('general.Fahrenheit') !!}</span></label>
                        </div>
