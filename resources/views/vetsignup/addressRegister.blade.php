            ...
            <div class="form-horizontal top-buffer">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 text-left">
                        {!! Form::text('zip', $vet->zip, array('class' => 'form-control text-left', 'autocomplete' => 'off')) !!}
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('address_1', Lang::get('general.Address line 1'), array('class' => 'col-sm-4 control-label')) !!}
                    <div class="col-sm-8">
                        {!! Form::text('address_1', $vet->address_1, array('class' => 'form-control text-left')) !!}
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('address_2', Lang::get('general.Address line 2'), array('class' => 'col-sm-4 control-label')) !!}
                    <div class="col-sm-8">
                        {!! Form::text('address_2', $vet->address_2, array('class' => 'form-control text-left')) !!}
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('city', Lang::get('general.Town/City'), array('class' => 'col-sm-4 control-label')) !!}
                    <div class="col-sm-8">
                        {!! Form::text('city', $vet->city, array('class' => 'form-control text-left')) !!}
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('county', Lang::get('general.County'), array('class' => 'col-sm-4 control-label')) !!}
                    <div class="col-sm-8">
                        {!! Form::text('county', $vet->county, array('class' => 'form-control text-left')) !!}
                    </div>
                </div>
            </div>
        </div>
