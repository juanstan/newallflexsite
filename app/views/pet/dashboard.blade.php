...
@section('content')
    ...
    <div class="row col-md-11 float-none col-centered collapse-group" >
        <div class="collapse" id="file-upload">
            ...
            {{ Form::open(array('files'=> 'true', 'url' => '/pet/dashboard/reading-upload', 'class'=>'dropzone', 'method' => 'post')) }}
            {{ Form::close() }}
                ...
                <div class="row" >
                    <div class="col-md-12" >
                        ...
                        <div class="tab-content ">
                            <div class="col-md-9 active tab-pane fade in small-padding" id="pet-name{{ $value->id }}" >
                    ...
                    <div class="tab-content ">
                        ...
                        <div  class="tab-pane fade in" id="edit{{ $value->id }}">
                            <div class="form-horizontal float-none top-buffer col-md-12 col-centered">
                                {{ Form::open(array('url' => array('/pet/dashboard/update-pet', $value->id), 'method' => 'post', 'id' => 'petSettingsForm')) }}
                                ...
                                {{ Form::open(array('url' => array('/pet/dashboard/reset-average-temperature', $value->id), 'method' => 'post')) }}
            ...
            <div class="tab-content ">
                ...
                <div  class="tab-pane fade in" id="newPetDetails">
                    <div class="jumbotron dashboard large-top-buffer" >
                        ...
                        <div class="form-horizontal float-none  top-buffer col-md-12 col-centered">
                            {{ Form::open(array('files'=> 'true', 'url' => '/pet/dashboard/create-pet', 'method' => 'post')) }}
