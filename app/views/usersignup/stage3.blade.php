        ...
        <div class="col-md-6 col-centered float-none hidden-desktop" >
            <div class="form-horizontal top-buffer">
                    ...
                    <div class="col-md-12 col-centered top-buffer" >
                        @if($pets->isEmpty())
                        <a href="/user/register/pet/create" >
        ...
        <div class="col-md-12 col-centered" >
            <div class="form-group" >
                    <div class="col-sm-12">
                        ...
                        @if($pets->isEmpty())
                            <a href="/user/register/vet" >{{ Form::button(Lang::get('general.Skip'), array('class' => 'btn btn-file border-none btn-lg pull-right')) }}</a>
                        @else
                            <a href="/user/register/vet" >{{ Form::button(Lang::get('general.Next'), array('class' => 'btn btn-default border-none btn-lg pull-right')) }}</a>
                        @endif
