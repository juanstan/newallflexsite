        ...
        <div class="col-md-12 col-centered" >
            <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <a href="{{ URL::route('user.register.pet') }}" >{{ Form::button(Lang::get('general.Back'), array('class' => 'btn btn-file btn-lg pull-left border-none')) }}</a>
                        
                        <a href="{{ URL::route('user.register.reading') }}" >{{ Form::button(Lang::get('general.No thanks, skip'), array('class' => 'btn btn-default btn-lg border-none pull-right')) }}</a>
